...
/**
 * @file KeeponFamilyDayModule.h
 * @brief module that provides an interface to the keepon
 */

#ifndef _KEEPON_COACH_MODULE_H_
#define _KEEPON_COACH_MODULE_H_
#include <iostream>
#include <string>
...
class KeeponCoachModule:public yarp::os::RFModule {
    ...
    /*  */
	KeeponCoachThread *thread;            // pointer to a new thread to be created and started in configure() and stopped in close()

public:

	KeeponCoachModule(); // constructor default
    ~KeeponCoachModule();
